...
<section class="section doctors">
  <div class="container">
  	  <div class="row justify-content-center">
             <div class="col-lg-6 text-center">
                <div class="section-title">
                    ...
                    <p>Meet Our Doctor: Learn more about the experienced professionals dedicated to your care and well-being. </p>
                </div>
            </div>
        </div>
    ...
    <div class="row shuffle-wrapper portfolio-gallery">
                ...
                $query = "SELECT * FROM doctor JOIN specialist ON specialist.id_specialist = doctor.id_specialist";
	      	...
	      	<div class="position-relative doctor-inner-box">
		        <div class="doctor-profile">
	               <div class="doctor-img">
	               		<img src="images/team/<?php echo $row['photo_doctor']; ?>" alt="doctor-image" class="img-fluid w-100">
	               </div>
	            </div>
                <div class="content mt-3">
                	<h4 class="mb-0"><a href="#"><?php echo $row['name_doctor']; ?></a></h4>
                	<p><?php echo $row['name_specialist']; ?></p>
                </div> 
	      	</div>
      	</div>
		  <?php } ?>
		...
		<div class="row">
			<div class="col-lg-7">
				<div class="cta-content">
					...
					<h2 class="mb-5 text-lg">Your Path to Joyful Healing <span class="title-color">Begins at HaHaHealth!</span></h2>

    ...
    <div class="row">
          ...
          <div class="mt-3">
            <div class="feature-icon mb-3">
             ...
             <span class="h3">Call for an Emergency Service!</span>
              <h2 class="text-color mt-3">10-800-700 </h2>
          </div>
      </div>
      ...
      <div class="col-lg-8">
        <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
          ...
          <p class="mb-4">Schedule Now: Secure your appointment with us hassle-free, ensuring timely access to our services.</p>
          <form action="" class="appoinment-form" method="POST" onsubmit="handleFormSubmit()">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  <select class="form-control" id="id_doctor" name="id_doctor">
                    ...
                    <?php 
                      ...
                      while($data3 = $query->fetch_assoc()):
                    ?>
                    <option value="<?= $data3['id_doctor']; ?>"><?php echo $data3['name_doctor'];?></option>
                    <?php endwhile; ?>
                  </select>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <input name="date_appointment" id="date_appointment" type="date" class="form-control" placeholder="date">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <select class="form-control" name="time_appointment" id="time_appointment">
              ...
              <div class="col-lg-12">
                <button type="submit" class="btn btn-main btn-round-full" name="simpan">Make Appointment</button>
              </div>
            </div>
          </form>
        </div>
...
<footer class="footer section gray-bg">
	...
	<!-- Script JavaScript untuk menangani alert -->
    <script>

...
$booked = mysqli_query($conn, "SELECT * FROM appointment WHERE status ='Booked'");
$completed = mysqli_query($conn, "SELECT * FROM appointment WHERE status ='Approved'");

// menghitung data 
$total_patient = mysqli_num_rows($patient);
$total_doctor = mysqli_num_rows($doctor);
$total_booked = mysqli_num_rows($booked);
$total_completed = mysqli_num_rows($completed);
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Appointment "Boked"
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $total_booked; ?></div>
                                                </div>
                                            </div>
                                        </div>
